...
class osteoporosis_classifier(object):
    ...
    def ResNet(self, x_input, classes):
        ...
        with tf.variable_scope('reference'):
            ...
            logits_2 = tf.layers.dense(logits_128, units=classes, activation=None)
        ...
        with tf.Session() as sess:
            ...
            if evaluate_train == True:
                ...
                if train_size % train_batch_size == 0:
                    ...
                    book.save('./resnet_featureTrain.xls')
...
def load_data_list():
    ...
    # Y_all_list = []
    # for i in range(2):
    #     dir = './Data_python/Vgg_Res/Vgg_Res_data_8/original_CLAHE/%s/' % i
    #     for image_name in os.listdir(dir):
    #         image_path = dir + image_name
    #         X_all_list.append(image_path)
    #         Y_all_list.append(i)

    # return X_train_list, Y_train_list, X_all_list, Y_all_list
...
def main(_):
    ...
    model.evaluate(X_train_list, Y_train_list, X_test_list, Y_test_list, True, model_path='/home/linghe/code/~/model_saving/ResNet/2018-11-28_10.58/proteinModel-35')
